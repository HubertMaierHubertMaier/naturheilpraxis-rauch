-- Vorhersicherung SLH-2026-08-23-002
-- Erstellt: 2026-08-23 (UTC) vor Anwendung von 20260728120000_add_vieva_plus_patient_input.sql
-- Zweck: exakter Rollback der beiden betroffenen Funktionen auf den Live-Stand VOR der Migration.
--
-- Live-Stand vor Migration:
--   public.compact_therapy_session_input(jsonb, integer)  def_len=3175  md5=a39f4e023bd094461023ea6171d17af9
--   public.extract_patient_snapshot_fields(jsonb)         def_len=2766  md5=c68b7f201e4410f91099ff56a9e9ed82
--   Beide OHNE vievaPlus / vievaPlusDatum / metatronDatum.
--
-- Rollback: dieses Skript unveraendert als eine Migration ausfuehren.
