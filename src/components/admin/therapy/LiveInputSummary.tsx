...
import { ListChecks, Activity, Stethoscope, FlaskConical, FileText, Microscope, Radio, ClipboardList, Search, ShoppingCart, FileType } from "lucide-react";
...
/**
 * Live-Übersicht der erfassten Symptome, Diagnosen und Untersuchungen.
...
export function LiveInputSummary({
  ...
  const totalCount =
    symptomList.length + erkrankungList.length +
