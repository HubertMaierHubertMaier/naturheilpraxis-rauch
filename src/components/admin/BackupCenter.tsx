  ...
  const downloadAreaBackup = async (area: BackupArea) => {
    ...
    try {
      ...
      const wikiBridgeRestoreLines = area.id === "wiki" ? [
        ...
        "8. `kb_export_wiki_snapshot()` ausfuehren und nur committen, wenn `missing_articles`, `invalid_current_snapshots`, `orphaned_active_articles`, `invalid_source_promotions`, `invalid_therapeutic_catalog_revisions`, `invalid_entity_candidate_contracts`, `invalid_entity_candidate_draft_promotions`, `invalid_knowledge_releases`, `invalid_dosage_rules`, `invalid_safety_rules`, `invalid_search_documents`, `invalid_lab_parameter_revisions`, `invalid_lab_reference_ranges`, `invalid_lab_finding_definition_revisions`, `invalid_homeopathic_repertory_revisions`, `invalid_homeopathic_rubrics`, `invalid_homeopathic_grade_definitions`, `invalid_homeopathic_repertory_remedies` und `invalid_homeopathic_rubric_remedy_assignments` jeweils 0 sind.",
