...
export const tableAccessMatrix: TableAccessMatrixEntry[] = [
  ...
  },
  {
    ...
    policySummary: "Admins read the table directly; public clients request only known routes through a bounded function.",
    riskNote: "Keep full-table reads private and never use DB overrides to downgrade code-marked therapy content below patient-only access.",
  },
  {
