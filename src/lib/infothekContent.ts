...
export const infothekGroups: InfothekGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: { de: "Dankbarkeit im Alltag", en: "Gratitude in Daily Life" },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Moon,
        description: { de: "3 Varianten + Eltern-Anleitung – Download nur über deine persönliche Patienten-Bibliothek (Login erforderlich).", en: "3 variants + parent guide – available only via your private patient library (login required)." },
        gated: true,
      },
    ],
  },
