  ...
  return (
    <Layout>
      <SEOHead
        ...
        description="Begleitende Hypnose-Materialien für einen ruhigen Bauch – ausschließlich über die geschützte Patienten-Bibliothek erreichbar."
      />
        ...
        <div className="container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground leading-relaxed">
              Innere Ruhe & Gelassenheit für Bauch, vegetatives Nervensystem und Beckenboden.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-foreground leading-relaxed">
                    ...
                    Verlaufstagebuch und Begleitskript stehen <strong>ausschließlich</strong> im
                    geschützten Bereich für freigeschaltete Patientinnen und Patienten bereit.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2 text-sm text-foreground leading-relaxed">
                  ...
                  <ul className="space-y-1 list-disc pl-5 text-muted-foreground">
                    <li>Blut im Stuhl oder schwarzer Teerstuhl</li>
                    <li>Ungewollter Gewichtsverlust oder anhaltendes Fieber</li>
                    <li>Nächtlicher Durchfall, der dich aus dem Schlaf reißt</li>
                    <li>Plötzliche Änderung der Stuhlgewohnheiten ohne Anlass, länger als 2 Wochen</li>
                  </ul>
                </div>
              </div>
            </CardContent>
