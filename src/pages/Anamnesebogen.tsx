    ...
    <div className="container py-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="relative mb-8">
          <div ref={scrollContainerRef} className="flex items-center overflow-x-auto pb-2" style={{ WebkitOverflowScrolling: 'touch', scrollbarWidth: 'thin', scrollbarColor: 'hsl(var(--primary) / 0.4) hsl(var(--muted))' }}>
